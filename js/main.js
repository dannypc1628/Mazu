...
const defaultMilliseconds = 1500;
let intervalMilliseconds = defaultMilliseconds;
var previousYear;
...
function go() {
    stop();
    timer = setInterval(autoAddYear, intervalMilliseconds);
    goChecked = true;
}
...
function speed(value) {
    intervalMilliseconds = defaultMilliseconds / value;
    if (goChecked) {
        clearInterval(timer);
        timer = setInterval(autoAddYear, intervalMilliseconds);
    }
